...
export default function LoginScreen({ navigation, onOpenAdmin }) {
  ...
  const handleLogin = (isQuickAdmin = false) => {
    ...
    setTimeout(async () => {
      let user = null;
      if (isQuickAdmin) {
        user = { id: 'farm_001', name: 'रामराव शिंदे' };
      } else if (farmerId === 'farm_001' && password === 'agri123') {
        user = { id: 'farm_001', name: 'रामराव शिंदे' };
      }
      
      if (user) {
        await AsyncStorage.setItem('authFarmer', JSON.stringify(user));
        showToast(t('लॉगिन सफल!', 'Login Successful!', 'लॉगिन यशस्वी!'), 'success');
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={[TEXT_STYLES.h4, styles.easyBtnTitle]}>{t('डेमो के लिए क्लिक करें', 'Quick Demo Access', 'डेमोसाठी येथे टिचकी मारा')}</Text>
